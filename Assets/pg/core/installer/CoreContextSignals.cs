...
{
    public class RequestStateChangeSignal : Signal<Type, RequestStateChangeSignal> { }
    public class SendSceneParamsSignal : Signal<BaseSceneParams, SendSceneParamsSignal> { }
