...
namespace RSG
{
    //ADDED: This is our custom base class for all types of promises
    public interface IBasePromise
    {
        ...
        /// </summary>
        IBasePromise BaseThen<ConvertedT>(Func<IPromise<ConvertedT>> onResolved);

        /// <summary>
        /// Add a resolved callback that chains a non-value promise.
        /// </summary>
        IBasePromise BaseThen(Func<IPromise> onResolved);

        /// <summary>
        /// Add a resolved callback.
        /// </summary>
        IBasePromise BaseThen(Action onResolved);

        /// <summary>
        /// Add a resolved callback and a rejected callback.
        /// The resolved callback chains a value promise (optionally converting to a different value type).
        /// </summary>
        IBasePromise BaseThen<ConvertedT>(Func<IPromise<ConvertedT>> onResolved, Action<Exception> onRejected);

        /// <summary>
        /// Add a resolved callback and a progress callback.
        /// The resolved callback chains a non-value promise.
        /// </summary>
        IBasePromise BaseThen(Func<IPromise> onResolved, Action<Exception> onRejected);

        /// <summary>
        /// Add a resolved callback and a rejected callback.
        /// </summary>
        IBasePromise BaseThen(Action onResolved, Action<Exception> onRejected);
        ...
        /// The resolved callback chains a value promise (optionally converting to a different value type).
        /// </summary>
        IBasePromise BaseThen<ConvertedT>(Func<IPromise<ConvertedT>> onResolved, Action<Exception> onRejected, Action<float> onProgress);

        /// <summary>
        /// Add a resolved callback, a rejected callback and a progress callback.
        /// The resolved callback chains a non-value promise.
        /// </summary>
        IBasePromise BaseThen(Func<IPromise> onResolved, Action<Exception> onRejected, Action<float> onProgress);

        /// <summary>
        /// Add a resolved callback, a rejected callback and a progress callback.
        /// </summary>
        IBasePromise BaseThen(Action onResolved, Action<Exception> onRejected, Action<float> onProgress);
        ...
        /// of the promise.
        /// </summary>
        //IBasePromise Progress(Action<float> onProgress);
    }
    ...
    public interface IPromise : IBasePromise
    {
        ...
        /// </summary>
        /// ADDED: Progress ripped from 3.0
        IPromise Progress(Action<float> onProgress); //ADDED: Progress ripped from 3.0
    }
...
//            Argument.NotNull(() => onRejected);
        ...
        {
            return Then(onResolved, onRejected, onProgress);
        }
        ...
        /// <summary>
        /// Chain a number of operations using promises.
        /// Takes a number of promises and creates functions,
        /// each of which starts an async operation and yields a promise.
        /// </summary>
        public static IPromise Sequence(params IPromise[] prms)
        {
            Func<IPromise>[] fns = new Func<IPromise>[prms.Length];
